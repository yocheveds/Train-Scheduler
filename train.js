...
// Grabs user input
  ...
  var trainstartTimeformat= moment($("#train-time-input").val().trim(), "DD/MM/YY").format("X");
  var trainFrequency = $("#frequency-input").val().trim();
  var trainstartTime = $("#train-time-input").val().trim();
  ...
  var trainminute = moment().diff(moment(trainStartPretty), "minutes");
  // Calculate the total billed rate
  var trainfrequency = trainminute * trainDestination;
    
  var tRemainder = trainminute % trainFrequency;

  var trainminute = trainFrequency - tRemainder;

  var nextTrain = moment().add(trainminute, "minutes");

  var nextTraintime = moment(nextTrain).format("hh:mm");
  // Add each train's data into the table
  console.log(nextTrain);
  $("#train-table > tbody").append("<tr><td>" + trainName + "</td><td>" + trainDestination + "</td><td>" +
  trainFrequency + "</td><td>" + nextTraintime + "</td><td>" + trainminute + "</td></tr>");
});
